...
## Why is it important?
Email is used for OTPs, password resets, and notifications.

## How does it work?
The code uses Nodemailer with SMTP details to send messages.

## Interview-ready explanation
In simple words, this folder shows a real backend concept that solves a common problem. I would explain it as: "This example demonstrates how a server handles email sending in a practical way." 
